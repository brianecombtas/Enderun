...
namespace Enderun
{
    public class JournalEntry
    {
        ...
        void MapJournalAddRq(IMsgSetRequest requestMsgSet)
        {
            ...
            journalLineCredit.JournalCreditLine.AccountRef.FullName.SetValue("Furniture and Equipment");
            ...
            journalLineDebit.JournalDebitLine.AccountRef.FullName.SetValue("Capital Stock");
